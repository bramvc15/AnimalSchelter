	...
	public void run(String... args) {
		...
		List<Animal> animalList = List.of(
				...
				new Animal("KEB6685402", "Lizzy",
						...
						"European shorthair", "female", LocalDate.of(2020, 01, 01), 10, List.of(verblijfplaatsList.get(5)),
						kanMetLists.get(2)),
				new Animal("KEB4879500", "Kelly",
						...
						kanMetLists.get(3)),
				new Animal("KEB4871201", "Milo",
						"https://upload.wikimedia.org/wikipedia/commons/e/ef/GraceTheGreyhound.jpg", "greyhound", "female",
						LocalDate.of(2018, 03, 01), 80, List.of(verblijfplaatsList.get(8), verblijfplaatsList.get(9)),
						kanMetLists.get(4)),
				new Animal("KEB6936401", "Bella",
						"https://cdn.shopify.com/s/files/1/0009/1566/9028/files/chihuahua-heart-ID-tag_large.jpg?v=1547569168",
						"Golden retriever", "male", LocalDate.of(2016, 3, 18), 75.9999, List.of(verblijfplaatsList.get(10)),
						kanMetLists.get(5)),
				new Animal("KEB7418501", "Mr Whiskers",
						"https://greekreporter.com/wp-content/uploads/2021/09/aegean-cat-greece-breed-credit-anna-wichmann-greek-reporter.jpg",
						"Aegean", "male", LocalDate.of(2020, 5, 6), 30, List.of(verblijfplaatsList.get(13))
						,kanMetLists.get(6)),
				new Animal("KEB6487301", "Zeus",
						...
						kanMetLists.get(7)),
				new Animal("KEB9754102", "Kato",
						"https://cdn.shopify.com/s/files/1/1199/8502/files/persian-doll-face.jpg", "Persian doll face", "female",
						LocalDate.of(2018, 03, 01), 80, List.of(verblijfplaatsList.get(14)),
						kanMetLists.get(8)),
				new Animal("KEB6658702", "Lucy",
						"https://animals.net/wp-content/uploads/2018/09/Mini-Bull-Terrier-4-650x425.jpg",
						"mini bull terrier zwart", "female", LocalDate.of(2019, 04, 30), 80,
		...
		List<AdoptedAnimal> reserved = List.of(new AdoptedAnimal(animalList.get(0), false, null),
				new AdoptedAnimal(animalList.get(1), false, null), new AdoptedAnimal(animalList.get(2), false, null),
				new AdoptedAnimal(animalList.get(3), false, null), new AdoptedAnimal(animalList.get(4), false, null),
				new AdoptedAnimal(animalList.get(5), false, null), new AdoptedAnimal(animalList.get(6), false, null),
				new AdoptedAnimal(animalList.get(7), false, null), new AdoptedAnimal(animalList.get(8), false, null),
				new AdoptedAnimal(animalList.get(9), false, null));
